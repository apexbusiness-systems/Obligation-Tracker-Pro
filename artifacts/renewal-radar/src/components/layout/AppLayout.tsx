      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-white/10">
          ...
          <div className="min-w-0">
            <p className="font-bold text-sm text-white leading-tight">Renewal Radar</p>
            <p className="text-xs text-white/40 leading-tight mt-0.5 truncate">Obligation Tracker</p>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="lg:hidden flex items-center gap-3 px-4 py-3.5 border-b border-slate-200 bg-white shadow-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-sm text-slate-900">Renewal Radar</span>
          </div>
        </header>
